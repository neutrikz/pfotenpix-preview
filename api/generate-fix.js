// /api/generate-fix.js – RemBG + native fetch
...
export default async function handler(req, res) {
  console.log("✅ Aktuelle Version von generate-fix.js läuft");
  ...
  try {
    ...
    const replicateRes = await fetch('https://api.replicate.com/v1/predictions', {
      ...
      body: JSON.stringify({
        version: '7ed7f24468c2f47bbf4ed5e4b24ac01b78a24f1e1a9263001f21c83c0e3c8b4d', // RemBG
        input: {
    ...
    console.error("❌ Fehler in generate-fix.js:", err);
